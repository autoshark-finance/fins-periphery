...
describe('ExampleFlashSwap', () => {
  ...
  it('FinsV2Call:0', async () => {
    ...
    // now, execute arbitrage via FinsV2Call:
  ...
  it('FinsV2Call:1', async () => {
    ...
    expect(formatEther(profit)).to.eq('0.550274581178922238') // our profit is ~.5 ETH
